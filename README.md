...
[![GitHub Workflow Status](https://img.shields.io/github/workflow/status/mathemaphysics/kdtrace/CI)](https://github.com/mathemaphysics/kdtrace/actions?query=workflow%3ACI)
...
The following sequence of commands builds KDTrace.
...
the C++ test suite of `KDTrace` can be run using
...
KDTrace provides a Doxygen documentation. You can build
